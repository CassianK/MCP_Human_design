...
// Импортируем упрощенную версию для демонстрации
  ...
  tools: [
    {
      ...
      description: 'Рассчитывает карту Human Design по дате, времени и месту рождения',
      inputSchema: {
        type: 'object',
        properties: {
          birthDate: {
...
async function main() {
  ...
  console.error('Human Design MCP Server running on stdio');
}
